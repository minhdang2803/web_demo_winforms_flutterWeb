define(['dart_sdk', 'packages/stack_trace/src/utils.dart', 'packages/path/src/path_set.dart'], (function load__packages__stack_trace__src__stack_zone_specification_dart(dart_sdk, packages__stack_trace__src__utils$46dart, packages__path__src__path_set$46dart) {
  ...
  stack_zone_specification.StackZoneSpecification = class StackZoneSpecification extends core.Object {
    ...
    chainFor(trace) {
      ...
      let previous = (t0 = this[_chains]._get(trace), t0 == null ? this[_currentNode] : t0);
      if (previous == null) {
    ...
    [_errorCallback](self, parent, zone, error, stackTrace) {
      ...
      t1 = asyncError;
      return t1 == null ? new async.AsyncError.new(error, stackTrace) : t1;
    }
    [_createNode](level = 0) {
    ...
    [_run](T, f, node) {
      ...
      try {
        ...
        if (core.Object.is(e)) {
          t2 = this[_chains];
          t2._get(stackTrace) == null ? t2._set(stackTrace, node) : null;
          dart.rethrow(e$);
        } else
          throw e$;
      } finally {
    ...
    [_currentTrace](level = null) {
      ...
      return new lazy_trace.LazyTrace.new(dart.fn(() => {
        ...
        return new trace$.Trace.new(trace.frames[$skip](dart.notNull((t2 = level, t2 == null ? 0 : t2)) + (utils.inJS ? 2 : 1)), {original: text});
      }, T$.VoidToTrace()));
    }
    [_trimVMChain](trace) {
  ...
  lazy_chain.LazyChain = class LazyChain extends core.Object {
    get [_chain]() {
      let t3, t2;
      t2 = this[__LazyChain__chain];
      return t2 == null ? (t3 = this[_thunk$](), this[__LazyChain__chain] == null ? this[__LazyChain__chain] = t3 : dart.throw(new _internal.LateError.fieldADI("_chain"))) : t2;
    }
  ...
  dart.setLibraryUri(lazy_chain.LazyChain, I[1]);
  ...
  vm_trace.VMTrace = class VMTrace extends core.Object {
    ...
    toString() {
      ...
      return this.frames[$map](core.String, dart.fn(frame => {
        let t2, t2$, t2$0;
        let number = ("#" + dart.str((t2 = i, i = t2 + 1, t2)))[$padRight](8);
        ...
        let line = (t2$ = frame.line, t2$ == null ? 0 : t2$);
        let column = (t2$0 = frame.column, t2$0 == null ? 0 : t2$0);
  ...
  dart.setLibraryUri(vm_trace.VMTrace, I[2]);
  ...
  lazy_trace.LazyTrace = class LazyTrace extends core.Object {
    get [_trace]() {
      ...
      return t2 == null ? (t3 = this[_thunk$0](), this[__LazyTrace__trace] == null ? this[__LazyTrace__trace] = t3 : dart.throw(new _internal.LateError.fieldADI("_trace"))) : t2;
    }
    static ['_#new#tearOff'](_thunk) {
  ...
  (trace$.Trace.new = function(frames, opts) {
    let t2;
    let original = opts && 'original' in opts ? opts.original : null;
    this[frames$0] = T$.ListOfFrame().unmodifiable(frames);
    this[original$] = new core._StringStackTrace.new((t2 = original, t2 == null ? "" : t2));
    ;
  }).prototype = trace$.Trace.prototype;
  ...
  dart.setLibraryUri(trace$.Trace, I[5]);
  ...
  dart.setLibraryUri(frame$.Frame, I[6]);
    ...
    static current(level = 0) {
      ...
      return new lazy_chain.LazyChain.new(dart.fn(() => {
        ...
        return new chain$.Chain.new((() => {
          let t5 = T$.JSArrayOfTrace().of([first]);
          t5[$addAll](chain.traces[$skip](1));
          return t5;
        })());
      }, T$.VoidToChain()));
    }
  ...
  dart.setLibraryUri(chain$.Chain, I[7]);
